...
exports.text2Ellipsis = exports.noData = exports.drawRect = exports.drawLine = void 0;
...
const drawRect = (ctx, startX, startY, width, height, color) => {
  if (color) {
    ctx.save();
    ctx.fillStyle = color;
  }
...
const text2Ellipsis = (ctx, str, maxWidth, ellipsis = '…') => {
...
exports.text2Ellipsis = text2Ellipsis;

const noData = (ctx, x, y, w, h, originW = 140) => {
  ...
  ctx.closePath();
  ctx.stroke(); // center to left-top

  ctx.beginPath();
  ctx.lineTo(centerX, centerY);
  ctx.lineTo(centerX - cosWidth, centerY - sinWidth);
  ctx.stroke(); // center to right-top

  ctx.beginPath();
  ctx.lineTo(centerX, centerY);
  ctx.lineTo(centerX + cosWidth, centerY - sinWidth); // right-top

  ctx.stroke(); // center to bottom
